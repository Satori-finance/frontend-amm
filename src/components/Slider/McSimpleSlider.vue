<template>
  <div class="mc-simple-slider" :class="{'show-label': !hideLabel}">
    <VueSlider v-model="currentValue"
      ...
      <template v-slot:step="{ label, active }">
        ...
        <img v-else src="@/assets/img/slider-point.svg" alt="" :class="['mc-simple-slider__point', { active }]">
      </template>
    </VueSlider>
  </div>
</template>
...
export default class McSimpleSlider extends Vue {
