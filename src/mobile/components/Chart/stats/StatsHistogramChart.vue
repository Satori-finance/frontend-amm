<template>
  <div class="mobile-histogram-chart">
    ...
    <div class="histogram-container" v-show="!loading" ref="chartContainer">
...
import { histogramSeriesPartialOptions, createChartOptions } from '../chartOptions'
import McMRadioGroup from '../../RadioGroup.vue'
import elementResizeDetectorMaker from 'element-resize-detector'
import { StatsHistogramChartMixin } from '@/components/Chart/stats/statsHistogramChartMixin'
